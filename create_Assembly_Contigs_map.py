...
#--------------------------------------- 
#THIS SECTION OF THE CODE CREATES THE MAP BETWEEN ASSEMBLY ID AND CORRESPONDING SCAFFOLD IDs USING THE ASSEMBLY STRUCTURE FILES FOR ALL ASSEMBLIES IN E FAECALIS 
